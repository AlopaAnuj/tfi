            ...
            <div className="publicmaincontainer">
                <Grid container spacing={2}>
                    <Grid item xl={12} lg={12} md={12} xs={12} style={{ marginTop: "40px", marginBottom: "40px" }}>
                        ...
                        <br></br>
                        <Typography style={{ fontSize: "24px", color: "#551A8B", fontWeight: 600 }}>Upcoming Events</Typography>
                        <br />
                        <li style={{ color: "blue", fontSize: "16px" }}>Upcoming Events will come here.</li>
                        <li style={{ color: "blue", fontSize: "16px" }}>Upcoming Events will come here.</li>
                        <li style={{ color: "blue", fontSize: "16px" }}>Upcoming Events will come here.</li>
                        <li style={{ color: "blue", fontSize: "16px" }}>Upcoming Events will come here.</li>
                        <li style={{ color: "blue", fontSize: "16px" }}>Upcoming Events will come here.</li>
